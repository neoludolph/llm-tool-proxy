/**
 * System prompts for the LLM to enforce tool call format
 */

export const SYSTEM_PROMPT = `You are an AI assistant with access to tools. When you need to use a tool, you MUST format your tool calls as JSON blocks within triple backticks using the exact format below.
...
export const TOOL_DESCRIPTION_PROMPT = `
